...
.EXAMPLE
Publish-ModuleToTemplateSpec -componentTemplateSpecName 'KeyVault' templateFilePath 'C:/KeyVault/deploy.json' -componentTemplateSpecRGName 'artifacts-rg' -componentTemplateSpecRGLocation 'usgovvirginia' -componentTemplateSpecDescription 'iacs key vault' -customVersion '3.0.0'
