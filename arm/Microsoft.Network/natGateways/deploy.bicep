...
@description('Optional. DNS name of the Public IP resource. A region specific suffix will be appended to it, e.g.: your-DNS-name.usgovarizona.cloudapp.azure.com')
...
resource publicIP_lock 'Microsoft.Authorization/locks@2016-09-01' = if (lock != 'NotSpecified') {
